...
Аттестационная работа: бэкенд-сервис для сети магазинов электроники.
Реализовал REST API для управления товарами и звеньями сети (заводы, розница, ИП), с авторизацией сотрудников и фильтрацией по странам. Данные хранятся в PostgreSQL, используется Django REST Framework.
